""" miniseed to SAC
original: Yijian Zhou
modified: Weifan Lu (luweifan001@pku.edu.cn)
"""

import os, sys, glob
sys.path.append('/home/luwf/Software/data_prep')
import sac
from obspy import read, UTCDateTime

# i/o paths
raw_dir = '/data1/MenyuanDataRaw/alldata1'
seed_paths = glob.glob(os.path.join(raw_dir, '*.mseed'))
sac_root = '/data3/Menyuan_SAC'
...
for seed_path in seed_paths:
   # sac.seed2sac(seed_path, sac_root)
    sac.mseed2sac(seed_path, sac_root)
